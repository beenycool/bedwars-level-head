...
export const REDIS_STATS_FLUSH_INTERVAL_MS = Math.max(100, parseIntEnv('REDIS_STATS_FLUSH_INTERVAL_MS', 1000));
export const REDIS_MAX_STATS_BUFFER_SIZE = Math.max(10, parseIntEnv('REDIS_MAX_STATS_BUFFER_SIZE', 1000));
